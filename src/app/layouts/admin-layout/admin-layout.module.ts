...
import { DetallepaseadorgComponent } from '../../pages/paseadores/detallepaseadorg/detallepaseadorg.component';
...
@NgModule({
  ...
  declarations: [
    ...
    CandidatosFComponent,
    DetallefinalizadoComponent,
    PaseadoresComponent,
    DetallepaseadorgComponent,
    NuevopaseadorComponent,
