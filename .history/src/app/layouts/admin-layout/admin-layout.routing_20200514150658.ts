...
import { PaseadoresComponent } from '../../pages/paseadores/paseadores.component';
import { DetallepaseadorgComponent } from 'src/app/pages/paseadores/detallepaseadorg/detallepaseadorg.component';
import { NuevopaseadorComponent } from '../../pages/nuevopaseador/nuevopaseador.component';
...
export const AdminLayoutRoutes: Routes = [
    ...
    { path: 'paseadores',    component: PaseadoresComponent, canActivate: [AuthGuard]},
    { path: 'detallepaseadorg/:id',    component: DetallepaseadorgComponent, canActivate: [AuthGuard]},
    { path: 'nuevopaseador',    component: NuevopaseadorComponent, canActivate: [AuthGuard]}
];
